 ...
 */
let logLevel, logLabel, errorLogPath, warnLogPath, infoLogPath, debugLogPath, exceptionLogPath;
...
if (config.has("Logger.logLevel")) {
    ...
    logLevel = 'debug'
    console.log(chalk.orange("[CONFIG]:") + ` No logLevel is specified inside default.json config. Using default value: ${logLevel}`);
}
...
if (config.has("Logger.logLabel")) {
    ...
    logLabel = "AppDev";
    console.log(chalk.orange("[CONFIG]:") + ` No logLabel is specified inside default.json config. Using default value: ${logLabel}`);
}
...
if (config.has("Logger.errorLogPath")) {
    ...
    console.log(chalk.orange("[CONFIG]: ") + `No errorLogPath is specified inside default.json config. Using default value: ${errorLogPath}`);
}
...
if (config.has("Logger.warnLogPath")) {
    ...
    console.log(chalk.orange("[CONFIG]: ") + `No warnLogPath is specified inside default.json config. Using default value: ${warnLogPath}`);
}
...
if (config.has("Logger.infoLogPath")) {
    ...
    console.log(chalk.orange("[CONFIG]: ") + `No infoLogPath is specified inside default.json config. Using default value: ${infoLogPath}`);
}
...
if (config.has("Logger.debugLogPath")) {
    ...
    console.log(chalk.orange("[CONFIG]: ") + `No debugLogPath is specified inside default.json config. Using default value: ${debugLogPath}`);
}

if (config.has("Logger.exceptionLogPath")) {
    exceptionLogPath = config.get("Logger.exceptionLogPath");
    console.log(chalk.green("[CONFIG]: ") + `exceptionLogPath: ${exceptionLogPath}`);
} else {
    exceptionLogPath = 'logs/exception.log';
    console.log(chalk.orange("[CONFIG]: ") + `No exceptionLogPath is specified inside default.json config. Using default value: ${exceptionLogPath}`);
}
